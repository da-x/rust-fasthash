...
extern "C" {
    #[link_name = "\u{1}_Z18CityHash32WithSeedPKcyj"]
...
extern "C" {
    #[link_name = "\u{1}_Z10CityHash64PKcy"]
    pub fn CityHash64(buf: *const ::std::os::raw::c_char, len: usize) -> uint64;
}
extern "C" {
    #[link_name = "\u{1}_Z18CityHash64WithSeedPKcym"]
...
extern "C" {
    #[link_name = "\u{1}_Z19CityHash64WithSeedsPKcymm"]
...
extern "C" {
    #[link_name = "\u{1}_Z11CityHash128PKcy"]
    pub fn CityHash128(s: *const ::std::os::raw::c_char, len: usize) -> uint128;
}
extern "C" {
    #[link_name = "\u{1}_Z19CityHash128WithSeedPKcySt4pairImmE"]
...
extern "C" {
    #[link_name = "\u{1}_Z14CityHashCrc128PKcy"]
    pub fn CityHashCrc128(s: *const ::std::os::raw::c_char, len: usize) -> uint128;
}
extern "C" {
    #[link_name = "\u{1}_Z22CityHashCrc128WithSeedPKcySt4pairImmE"]
...
extern "C" {
    #[link_name = "\u{1}_Z14CityHashCrc256PKcyPm"]
...
extern "C" {
    #[link_name = "\u{1}_Z13MurmurHash64APKviy"]
...
extern "C" {
    #[link_name = "\u{1}_Z13MurmurHash64BPKviy"]
...
extern "C" {
    #[link_name = "\u{1}_Z27farmhash_fingerprint_uint64y"]
    pub fn farmhash_fingerprint_uint64(x: u64) -> u64;
}
extern "C" {
    #[link_name = "\u{1}_Z9mum_hash_PKvyy"]
    pub fn mum_hash_(key: *const ::std::os::raw::c_void, len: usize, seed: u64) -> u64;
}
extern "C" {
    #[link_name = "\u{1}_Z16SpookyHasherHashPKvyPyS1_"]
...
extern "C" {
    #[link_name = "\u{1}_Z16SpookyHasherInitPvyy"]
    pub fn SpookyHasherInit(h: *mut ::std::os::raw::c_void, seed1: uint64, seed2: uint64);
}
extern "C" {
    #[link_name = "\u{1}_Z18SpookyHasherUpdatePvPKvy"]
...
extern "C" {
    #[link_name = "\u{1}_Z17SpookyHasherFinalPvPyS0_"]
...
extern "C" {
    #[link_name = "\u{1}_Z8t1ha0_64PKvym"]
